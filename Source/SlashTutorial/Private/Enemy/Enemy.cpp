...
void AEnemy::DirectionalHitReact(const FVector& ImpactPoint)
{
	...
	const FVector CrossPorduct = FVector::CrossProduct(Forward, ToHit);
	if (CrossPorduct.Z < 0)
	{
		Theta *= -1.f;
	}
	...
	/*
	UKismetSystemLibrary::DrawDebugArrow(this, GetActorLocation(), GetActorLocation() + CrossPorduct * 100.f, 5.f, FColor::Blue, 5.f);
